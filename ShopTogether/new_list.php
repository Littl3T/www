...
if(isset($_POST["Name"]) and !empty($_POST["Name"])){
    $reqnew_list = $bd->prepare("INSERT INTO shoppinglist (ID_shoppingList, DateCreation, DateValidation, Name) VALUES(NULL, :ajd, NULL, :name)");
    ...
    $reqAddJoinTable= $bd->prepare("INSERT INTO user_shopping (ID_UserShopping, ID_user, ID_shopping) VALUES(NULL, :user, :idshoppingList)");
    $reqAddJoinTable->bindValue(':user', $_SESSION["login"]['ID_User']); // Par exemple, si l'id user se trouve en session
    $reqAddJoinTable->bindValue(':idshoppingList', $lastId);
    $reqAddJoinTable->execute();
    
    $message = "Shopping List Added with succes";
} else $message = "Please enter a valid shopping list name";
?>
<!DOCTYPE html>
<html lang="en">
<head>
